...
```json
{
  ...
  "phone": "+79991234567",
  "name": "Иван Иванов",
  "avatar_url": "https://storage.example.com/avatars/abc.jpg",
  "role": "donor",
  ...
  "data": [
    {
      ...
      "foundation": {
        ...
        "name": "Фонд помощи",
        "logo_url": "https://storage.example.com/logos/fond.png"
      },
      "title": "Помощь детям",
      "description": "Сбор средств для детского дома",
      "thumbnail_url": "https://storage.example.com/thumbs/campaign1.jpg",
      "status": "active",
...
```json
{
  ...
  "ends_at": "2026-06-01T00:00:00Z",
  "created_at": "2026-01-01T00:00:00Z",
  "video_url": "https://storage.example.com/videos/campaign1.mp4",
  "closed_early": false,
  "close_note": null,
  "documents": [
    {
      ...
      "file_url": "https://storage.example.com/docs/report-jan.pdf",
      "sort_order": 0
    }
  ],
  "thanks_contents": [
    {
      ...
      "type": "video",
      "media_url": "https://storage.example.com/thanks/video1.mp4",
...
[
  ...
  },
  {
    ...
    "file_url": "https://storage.example.com/docs/report-feb.pdf",
    "sort_order": 1
  }
]
```
...
[
  {
    ...
    "icon_url": "https://storage.example.com/achievements/first.png",
  ...
  },
  {
    ...
    "icon_url": "https://storage.example.com/achievements/streak7.png",
    "earned_at": null
  }
]
```
